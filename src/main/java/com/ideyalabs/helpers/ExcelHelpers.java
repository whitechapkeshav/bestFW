...
package com.ideyalabs.helpers;

import com.ideyalabs.exceptions.InvalidPathForExcelException;
...
public class ExcelHelpers {
    ...
    public static Object[][] provideExcelData(String excelPath, String sheetName, String colName) {
        ...
        try (FileInputStream file = new FileInputStream(excelPath)) {
            ...
            while (headerCellIterator.hasNext()) {
                ...
                if (colName.equals(headerCell.getStringCellValue())) {
                    columnIndex = headerCell.getColumnIndex();
                    break;
                }
            }

            // If the column exists, iterate through the rows and add data to the testData list
            if (columnIndex != -1) {
                ...
                while (rowIterator.hasNext()) {
                    ...
                    if (cell != null && cell.getCellType() == CellType.STRING) {
                        testData.add(new Object[]{cell.getStringCellValue()});
                    }
                }
            }
        ...
        Object[][] dataArray = new Object[testData.size()][];
